...
const getVisualizationLayer = (metric: string) => ({
    id: "occurrence-layer",
    type: "fill",
    paint: {
        "fill-color": [
...
export default function MapView() {
    ...
    const [visualizationMetric, setVisualizationMetric] = useState("new_cases")
    ...
    const visualizationLayer = useMemo(() => {
        return getVisualizationLayer(visualizationMetric)
    }, [visualizationMetric])
    ...
    return (
        <div className="relative w-full h-full">
            ...
            >
                <Source type="geojson" data={featureCollection}>
                    ...
                    <Layer
                        ...
                        filter={["in", "level", "lad"]}
                    />
                    <Layer beforeId="lad-outline" {...visualizationLayer} />
                    <Layer
                        id="msoa-fill"
                        beforeId="waterway-label"
                        {...msoaFill}
            ...
            <div className="absolute top-0 right-0 pt-8 pr-8">
                <Select.Root
                    value={visualizationMetric}
                    onValueChange={v => setVisualizationMetric(v)}
                >
                    <Select.Trigger />
                    <Select.Content>
                        <Select.Group>
